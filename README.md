...
**Current Limitations:**
- Doesn't handle images or tables within documents (text only)
- No conversation history between queries
- Single-language support (English optimized)

**Planned Improvements:**
- Multi-turn conversations with context retention
- Support for images and tables (multi-modal RAG)
...
This is a portfolio project, but suggestions and improvements are welcome! If you find a bug or have an idea:
...
- The LangChain team for their RAG framework
...
**Sourav Guruprasad**
- GitHub: [@sorv2k](https://github.com/sorv2k)
- LinkedIn: [souravguruprasad](https://linkedin.com/in/souravguruprasad)
- Email: sourav.guruprasad15@gmail.com

Built as part of my exploration of production-ready AI systems and local LLM deployment.